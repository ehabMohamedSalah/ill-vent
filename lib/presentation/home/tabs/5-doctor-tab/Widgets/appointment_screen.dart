          ...
          if (state is GetAppointmentError) {
            return Scaffold(
              ...
              body: ErrorWidgett(
                ...
                onPressed: () {
                  DrViewModelCubit.get(context).getAppointment();
                },
              ),
            );
          }
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          SlidableAction(
                            onPressed: (context) {
                              context
                                  .read<DrViewModelCubit>()
                                  .cancelAppointment(drID: "${appointment.id}");
                              Navigator.pushNamed(
                          ...
                          title: Row(
                            children: [
                              ...
                              Text(
                                ...
                                style: Appstyle.VerySmall15(context)
                                    .copyWith(color: Colors.black),
                              ),
                            ],
                          ),
                          subtitle: Text(
                              '${appointment.appointmentDate?.substring(0, 10)} at ${appointment.formattedTime}'),
