...
class DealDetailsScreen extends StatelessWidget {
  ...
  DealDetailsScreen({required this.deal});
  ...
  void _handleBooking(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BookingFormScreen(deal: deal),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(deal.name ?? "Deal Details"),
        centerTitle: true,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Spacer(),
                Text(
                  "Price: \$${deal.deals?.dealPrice?.toStringAsFixed(2)}",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.green,
